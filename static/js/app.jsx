  ...
  render: function() {
    ...
    <div className="container">
      <div className="col-xs-12 jumbotron text-center">
        <h1>DISCvR</h1>
        <p>Dicover Intelligent Systems for Cognitive Research</p>
...
var LoggedIn = React.createClass({
  ...
  componentDidMount: function() {
    this.serverRequest = $.get('https://localhost:3000/products', function (result) {
      this.setState({
        products: result,
      });
    }.bind(this));
  ...
  render: function() {
    return (
      <div className="col-lg-12">
        ...
        <h2>Welcome toDISCvR</h2>
        <p>Here you will find products</p>
        <div className="row">
